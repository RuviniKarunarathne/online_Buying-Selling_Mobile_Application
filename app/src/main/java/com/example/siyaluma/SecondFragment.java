...
public class SecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        answer1 = v.findViewById(R.id.f2_ans1);
        ques1 = v.findViewById(R.id.f2_qs1);
        question1lay = v.findViewById(R.id.f2_layout1);
        drop_up = v.findViewById(R.id.f2_drop_up_icon);
        bkg_Lay_1 = v.findViewById(R.id.f2_background_Lay_1);

        answer2 = v.findViewById(R.id.f2_ans2);
        ques2 = v.findViewById(R.id.f2_qs2);
        question_2_lay = v.findViewById(R.id.f2_layout2);
        drop_up_2 = v.findViewById(R.id.f2_drop_up_icon2);
        bkg_Lay_2 = v.findViewById(R.id.f2_background_Lay_2);

        answer3 = v.findViewById(R.id.f2_ans3);
        ques3 = v.findViewById(R.id.f2_qs3);
        question_3_lay = v.findViewById(R.id.f2_layout3);
        drop_up_3 = v.findViewById(R.id.f2_drop_up_icon3);
        bkg_Lay_3 = v.findViewById(R.id.f2_background_Lay_3);

        answer4 = v.findViewById(R.id.f2_ans4);
        ques4 = v.findViewById(R.id.f2_qs4);
        question_4_lay = v.findViewById(R.id.f2_layout4);
        drop_up_4 = v.findViewById(R.id.f2_drop_up_icon4);
        bkg_Lay_4 = v.findViewById(R.id.f2_background_Lay_4);
