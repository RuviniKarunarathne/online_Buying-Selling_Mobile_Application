...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        answer1 = v.findViewById(R.id.ans1);
        ques1 = v.findViewById(R.id.qs1);
        question1lay = v.findViewById(R.id.layout1);
        drop_up = v.findViewById(R.id.drop_up_icon);
        bkg_Lay_1 = v.findViewById(R.id.background_Lay_1);

        answer2 = v.findViewById(R.id.ans2);
        ques2 = v.findViewById(R.id.qs2);
        question_2_lay = v.findViewById(R.id.layout2);
        drop_up_2 = v.findViewById(R.id.drop_up_icon2);
        bkg_Lay_2 = v.findViewById(R.id.background_Lay_2);

        answer3 = v.findViewById(R.id.ans3);
        ques3 = v.findViewById(R.id.qs3);
        question_3_lay = v.findViewById(R.id.layout3);
        drop_up_3 = v.findViewById(R.id.drop_up_icon3);
        bkg_Lay_3 = v.findViewById(R.id.background_Lay_3);

        answer4 = v.findViewById(R.id.ans4);
        ques4 = v.findViewById(R.id.qs4);
        question_4_lay = v.findViewById(R.id.layout4);
        drop_up_4 = v.findViewById(R.id.drop_up_icon4);
        bkg_Lay_4 = v.findViewById(R.id.background_Lay_4);

        //String colortg = getArguments().getString(String.valueOf(R.color.faq_qs_color));
